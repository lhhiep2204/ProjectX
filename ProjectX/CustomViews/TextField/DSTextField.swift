...
struct DSTextField: View {
    ...
    private var borderWidth: CGFloat {
        object.disabled ? 0 : DSConstants.Stroke.thick
    }
    ...
    var body: some View {
        VStack(
            alignment: .leading,
            spacing: DSConstants.Spacing.spacing4
        ) {
...
extension DSTextField {
    ...
    private var inputView: some View {
        HStack(spacing: DSConstants.Spacing.spacing8) {
            object.image
        ...
        .padding(.horizontal, DSConstants.Spacing.spacing12)
        .background(Color.appColor(.bgSecondary))
        .cornerRadius(DSConstants.Radius.xxLarge)
        .overlay {
            RoundedRectangle(cornerRadius: DSConstants.Radius.xxLarge)
    ...
    private var textFieldView: some View {
        ...
        .if(object.axis == .horizontal) {
            $0.frame(height: DSConstants.Size.textFieldHeight)
        } else: {
            $0.padding(.vertical, DSConstants.Spacing.spacing8)
        }
        .focused($editing)
